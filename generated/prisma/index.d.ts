...
export namespace Prisma {
  ...
  */
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"in" | "createdAt" | "updatedAt" | "email" | "hash" | "firstName" | "lastName", ExtArgs["result"]["user"]>
  ...
  export interface UserDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * 
     * // Only select the `in`
     * const userWithInOnly = await prisma.user.findMany({ select: { in: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Users and only return the `in`
     * const userWithInOnly = await prisma.user.createManyAndReturn({
     *   select: { in: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more Users and only return the `in`
     * const userWithInOnly = await prisma.user.updateManyAndReturn({
     *   select: { in: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  export type BookmarkOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"in" | "createdAt" | "updatedAt" | "title" | "description" | "link", ExtArgs["result"]["bookmark"]>
  ...
  export interface BookmarkDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * 
     * // Only select the `in`
     * const bookmarkWithInOnly = await prisma.bookmark.findMany({ select: { in: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Bookmarks and only return the `in`
     * const bookmarkWithInOnly = await prisma.bookmark.createManyAndReturn({
     *   select: { in: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more Bookmarks and only return the `in`
     * const bookmarkWithInOnly = await prisma.bookmark.updateManyAndReturn({
     *   select: { in: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface BookmarkFieldRefs {
    readonly in: FieldRef<"Bookmark", 'Int'>
  ...
  export type UserScalarWhereWithAggregatesInput = {
    ...
    in?: IntWithAggregatesFilter<"User"> | number
  ...
  export type BookmarkScalarWhereWithAggregatesInput = {
    ...
    in?: IntWithAggregatesFilter<"Bookmark"> | number
